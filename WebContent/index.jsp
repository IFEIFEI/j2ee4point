...
<!--[if gt IE 8]><!--><html lang="en-US" ><!--<![endif]-->
	...
	<head>
		...
		<script  src='js/home/dany-index.js'></script>
	...
	<section>
		...
		<div id="dynamic" class="home page page-id-5 page-template page-template-_templates page-template-home page-template-_templateshome-php">
				...
				<div id="header_container" data-type="background" data-speed="3"   style="background-image: url('images/user/footerr.png');">
					...
					<div class="caption">
						<h1 id="fit">正在展出<br><a href="">LAFAYETTE</a><br>148 NEW YORK 中国女性艺术家邀请展</h1>
					</div>
				...
				<div id="limiter">
					    ...
					    <div id="shows" class="box">
							<div class="show_panel"  id="column1">
								<div class="caption">当代中国画邀请展亮相太庙<i class="fa fa-angle-right"></i></div>
									...
									<div class="thumb" style="background-image: url('images/user/show4.jpg');"></div>	
							</div>
							...
							<div class="show_panel" id="column2">
								...
								<div class="caption">专访油画家洪凌先生<i class="fa fa-angle-right"></i></div>		
									...
									<div class="thumb" style="background-image: url('images/user/show3.jpg');"></div>																		
							</div>
                        </div>

						<div id="shows" class="box">

							<div class="show_panel" id="column3">
								...
								<div class="caption">藏品撷英：《仪礼》简与铜奔马<i class="fa fa-angle-right"></i></div>
									...
									<div class="thumb" style="background-image: url('images/user/show5.jpg');"></div>															
							</div>

							<div class="show_panel" id="column4">
	                ...
	                <div id="shop_section" class="clearfix">
						...
						<div id="head" class="clearfix">
							...
							<!--<h4>Featured</h4>-->
							<!--此处是商城的链接-->
							<p class="link"><a href="getArtwork">全部艺术品<i class="fa fa-external-link-square"></i></a></p>
						</div>
		...
		<div id="custom_sales">
			...
			<p></p>
						...
						<div id="artist_list">
						    ...
						    <!--此处要链接具体艺术家主页-->
							<a href="" class="person clearfix"><img src="images/user/person1.jpg" class="mug">
									<span>黄京哲</span>
								</a>
							<a href="" class="person clearfix"><img src="images/user/person2.jpg" class="mug">
									<span>Dora Maar</span>
								</a>
							<a href="" class="person clearfix"><img src="images/user/person3.jpg" class="mug">
									<span>董平</span>
								</a>
							<a href="" class="person clearfix"><img src="images/user/person4.jpg" class="mug">
									<span>Banksy</span>
								</a>
							<a href="" class="person clearfix"><img src="images/user/person5.jpg" class="mug">
									<span>Seba Kurtis</span>
								</a>

							<a href="" class="person clearfix"><img src="images/user/person6.jpg" class="mug">
