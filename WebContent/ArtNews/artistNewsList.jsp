...
<script type='text/javascript' src="js/newslist_js1.js"></script>
<script type='text/javascript' src="js/newslist_js2.js"></script>
<script type='text/javascript' src="js/newslist_js3.js"></script>
<link rel="stylesheet" type="text/css" href="css/info.css" type='text/css' media='all' />
<link rel='stylesheet' id='style-css'  href='css/style.css' type='text/css' media='all' />
<link rel='stylesheet' id='icons-css'  href='css/newslist_css1.css' type='text/css' media='all' />
            ...
            <div class="clearfix">
                <div class="daohang">
	                <div class="kind-of-news">
	                     <ul>
				            <li><a href="info_show.jsp">展出</li>
				            <li><a href="info_artwork.jsp">艺术品</li>
				            <li class="active-li"><a href="info_artist.jsp">艺术家</li>
	            ...
	            <div class="news">
	                ...
	                <c:forEach items='${artNewsList}' var="artNews" varStatus="status">
	                <a href="getArtNewsDetailById?&artNewsId=${artNews.id }">
	                    <div class="newsblock" >
	                    
	                        <div class="thumb">
	                        	<img src="${ artNews.imageURL}">
	                        </div>
	                        <div class="text">
							    <h4>${artNews.title }</h4>
							    <p style="color:#3e4251;">${artNews.summary}<br /></p>
						    </div>
	                    </div>
	                    </a>
	                  </c:forEach>  
