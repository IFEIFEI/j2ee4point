            ...
            <hr />
						<form action="" method="post" accept-charset="utf-8" class="examples part">
						    ...
						    <div class="fields">
                                ...
                                <span class="dk_wrap">
                                    <select name="country" class="cs-select cs-skin-elastic">
                                        <option value="" disabled selected>国家</option>
                                        <option value="ALL">全部</option>
                                        <option value="AU">中国</option>
                                        <option value="CA">美国</option>
                                        <option value="DE">英国</option>
                                        <option value="JP">法国</option>
                                        <option value="GB">其他</option>
                                    </select>
                                </span>
				...
				<div id="show_area" class="clearfix">
					<div class="container clearfix">
					    ...
					    <a href="" class="past_show clearfix">
							<div class="thumb" style="background-image: url('images/user/person1.jpg'); opacity:;"></div>
						<div class="text">
							<h3 style="color:#3e4251;">黄京哲 <br /></h3>
						</div>
					   </a>

					   <a href="" class="past_show clearfix">
							<div class="thumb" style="background-image: url('images/user/person2.jpg'); opacity:;"></div>
						<div class="text">
							<h3 style="color:#3e4251;">Huguette Arthur Bertrand <br /></h3>
						</div>
					   </a>

					   <a href="" class="past_show clearfix">
							<div class="thumb" style="background-image: url('images/user/person3.jpg'); opacity:;"></div>
						<div class="text">
							<h3 style="color:#3e4251;">Dora Maar <br /></h3>
						</div>
					   </a>

					   <a href="" class="past_show clearfix">
							<div class="thumb" style="background-image: url('images/user/person4.jpg'); opacity:;"></div>
						<div class="text">
							<h3 style="color:#3e4251;">董平 <br /></h3>
						</div>
					   </a>

					   <a href="" class="past_show clearfix">
							<div class="thumb" style="background-image: url('images/user/person5.jpg'); opacity:;"></div>
						<div class="text">
					   ...
					   <a href="" class="past_show clearfix">
							<div class="thumb" style="background-image: url('images/user/person6.jpg'); opacity:;"></div>
						<div class="text">
							<h3 style="color:#3e4251;">Banksy <br /></h3>
						</div>
					   </a>

						<c:forEach items='${ allArtistList }' var="artist" varStatus="status">
							<a href="singleArtist?id=${artist.id }" class="past_show clearfix">
							<div class="thumb" style="background-image: url('images/user/${artist.imageURL}'); opacity:;"></div>
							<div class="text">
								<h3 style="color:#3e4251;">${artist.realName }<br /></h3>
							</div>
						   </a>						
						</c:forEach>
