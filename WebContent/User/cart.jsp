...
<script src="js/user/dany-cart.js"></script>
<script>
function mm(o)
{
...
<link rel='stylesheet' id='style-css'  href='css/cart.css' type='text/css' media='all' />
		...
		<div id="content">
			<div id="dynamic" class="page page-id-96 page-template page-template-_templates page-template-shows page-template-_templatesshows-php">
				...
				<div class="container">
				    <h1>购物车</h1>
				    <hr/>
						<c:forEach items='${ shopCar }' var="artwork" varStatus="status">
							<div class="cartArtwork">
					            <ul>
					                ...
					                <li id="artistName"><p>${artwork.artistName}</p></li>
					                <li id="artworkPrice" class="artworkPrice"><p class="price">${artwork.price}</p></li>
					                <li id="artworkNumber" class="artworkNumber">
					                   <a class="min" artworkId="${artwork.id }">-</a>
					                   <input class="text_box"type="text" value="1"  name="">
					                   <a class="add" artworkId="${artwork.id }">+</a>
                                    </li>
					                <li id="artworkEdit"><a class="delete" artworkId="${artwork.id }" href="">删除</a></li>
					            </ul>
					        </div>						
						</c:forEach>
