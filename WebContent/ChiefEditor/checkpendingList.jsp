    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="ChiefEditor-index.html">艺术品订制网站后台管理系统</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<th >操作</th>
								...
								<td><td><a href="getArtNewsAllDetailByArtNewsId?artNewsId=${result.id }" style="color:black;"><i class="fa fa-file-text-o fa-fw"></i>审核</a></td></td>
							</tr>
							        </c:forEach>
						            </tbody>
                                </table>
