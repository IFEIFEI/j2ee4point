...
<svg width="98px" height="98px" viewBox="0 0 98 98" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
						...
						<div id="about_tabs" class="box">
							<div class="tab-content">
								<div class="tab-pane fade in active" id="login_info1">
									...
									<form action="userLoginByEmail" id="">
									    邮&nbsp;&nbsp;&nbsp;&nbsp;箱： <input type="email" name="email" id="email"><br><br>
									    密&nbsp;&nbsp;&nbsp;&nbsp;码： <input type="password" name="password" id="password"><br><br>
									    <input type="submit" value="提交" name="" id=""  class="button"><br><br>
									    <div id="zhucequ"><a href="register.jsp"><u>还未注册？点此注册</u></a></div>
									    <!--<input type="submit" value="忘记密码" name="" id=""  class="button">-->
                                    </form>
								</div>

								<div class="tab-pane fade" id="login_info2">
								
									<form action="userLoginByUserName" id="">
							...
							<ul class="tabs">
								<li class="active">
									<div href="#login_info1" data-toggle="tab" class="tab">
										
										<span>邮箱登录</span>
									</div>
								</li>
								<li>
									<div href="#login_info2" data-toggle="tab" class="tab">
	...
	<div class="show_panel">
	    <div class="thumb" style="background-image: url('images/user/ad2.jpeg');"></div>																
    </div>
    </div>
