                        ...
                        <div class="panel-heading">
                            ...
                            <div class="pull-right">
                                <button type="button" class="btn btn-default btn-xs" onclick="Preview()">
                                   <i class="fa fa-file-o fa-fw"></i>预览
                                </button>
                            </div>
                        </div>
...
ue.ready(function(){
    ue.setContent('${artNewsContent.content}');    
                                        ...
                                        <br/>
                                        <p class="pull-right">
                                            <input type="button" class="btn btn-outline btn-info" value="删除" onclick="if(window.confirm('确定删除该软文吗？')) this.href='deleteArtNewsById?artNewsId=${artNewsId}'"/>
			                                <input type="submit" class="btn btn-default btn-info" value="保存草稿" onclick="buttonsave()"/>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="pull-right">
                                ...
                                <button type="button" class="btn btn-default btn-xs" onclick="buttonsubmit()">
                                   <i class="fa fa-check fa-fw"></i>提交
                                </button>
                                <button type="button" class="btn btn-default btn-xs" onclick="if(window.confirm('确定删除该软文吗？')) this.href='deleteArtNewsById?artNewsId=${artNews.id}'">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row" style="margin: 10px 90px 10px 90px;">  
                                        <div class="col-lg-3">
					                       <p align="center" style="font-size:14px">作者：<span id="pauthor">${user.userName}</span></p>
				                        </div>
                                        <div class="col-lg-3">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="pull-right">
                                ...
                                <button type="button" class="btn btn-default btn-xs" onclick="if(window.confirm('确定删除该软文吗？')) this.href=''">
                                   <i class="fa fa-times fa-fw"></i>删除
                                </button>
                            </div>
                        </div>
...
<script type="text/javascript">
	...
	<script type="text/javascript">  
		...
		function buttonsave()
	     {
	    	 alert("保存成功");
	document.getElementById("draftform").action="updateDraft?artNewsId=${artNews.id}&state=uncommitted";
	document.getElementById("draftform").submit();
	     }
	     function buttonsubmit()
	     {
	    	 alert("提交成功");
	document.getElementById("draftform").action="updateDraft?artNewsId=${artNews.id}&state=underApproval";
	document.getElementById("draftform").submit();
	     }
   </script>
