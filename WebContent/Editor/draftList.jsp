                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
								...
								<td><a href="getArtNewsAllDetailByArtNewsId?artNewsId=${draft.id }" style="color:black;"><i class="fa fa-edit fa-fw"></i>编辑</a>&nbsp;&nbsp;
											<a style="color:black;" href="javascript:void(0)" onclick="if(window.confirm('确定删除该草稿吗？')) this.href='deleteArtNewsById?artNewsId=${draft.id}'"><i class="fa fa-trash-o fa-fw"></i>删除</a></td>
