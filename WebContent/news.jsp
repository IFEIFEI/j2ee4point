    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
				...
				<nav class="clearfix">
					<div class="menu-menu-1-container">
						<ul id="menu-menu-1" class="menu">
							...
							<li id="menu-item-98" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-98"><a href="artwork.jsp">艺术品</a></li>
  		...
  		<div id="mobile_menu">
			<div class="menu-menu-1-container">
				<ul id="menu-menu-2" class="menu">
					...
					<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-50"><a href="artwork.jsp">艺术品</a></li>
		...
		<div id="content" >
	        ...
	        <div  id="container1" class="clearfix">
	            <hr>
	            <h3>人民艺术专访油画家洪凌先生</h3>
                <p>洪凌：1955年生于北京。云南白族人。现任中央美术学院油画系第三工作室教授，中国美术家协会油画艺委会委员。作品将中国山水的涵养、气度与西方油画的视觉张力结合，实现了独特的自我表达。</p>
                <p>洪凌老师的访问，与以往略显不同：它脱离了一问一答的形式，更像一次系统地自我叙述，以醇厚的嗓音娓娓道来。不仅内容丰富，在用词的情感属性、力度上也非常准确。我们能做的，就是尽量去专注地倾听和理解。</p>
	        </div>
