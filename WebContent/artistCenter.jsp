      ...
      <div id="dynamic" class="page page-id-96 page-template page-template-_templates page-template-shows page-template-_templatesshows-php">
        ...
        <div class="container">
          <div id="tabs0"> 
            <ul class="menu0" id="menu0"> 
              <li class="hover" ><a href="artistCenter.html" >个人信息</a></li> 
              <li><a href="artistInfoMoney.html">个人账户</a></li> 
              <li><a href="artistArtwork.html">艺术品</a></li> 
              <li><a href="artistArtworkUpload.html">上传作品</a></li>
              <li><a href="artistAddress.html">地址管理</a></li>   
              <li><a href="artistRecord.html">购买记录</a></li>  
            </ul> 
            <hr />
          </div>
        </div>
        ...
        <div class="container">
              ...
              <form action="" id="infoCenter">
                  ...
                  <b>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</b><input type="text" id="realname"  name="realName"  disabled="disabled"/><br><br>
                  ...
                  <!--可编辑-->
                  <b>个人描述：</b><textarea name="descrition" id="descrition"></textarea><br><br>
