...
<link rel='stylesheet' id='style-css'  href='css/artistRegister.css' type='text/css' media='all' />
  </head>
    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
        ...
        <nav class="clearfix">
          ...
          <ul id="menu-menu-1" class="menu">
                            ...
                            <li id="menu-item-617" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-617"><a href="">登录</a></li>
                    </ul>
                    </div>        
                </nav>
    ...
    <div id="mobile_menu">
      ...
      <ul id="menu-menu-2" class="menu">
              <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-50"><a href="index.html">首页</a></li>
                    ...
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-617"><a href="">登录</a></li>
            </ul>
            </div>      
            <div class="hamburger">
      ...
      <div id="dynamic" class="page page-id-96 page-template page-template-_templates page-template-shows page-template-_templatesshows-php">
        ...
        <div class="container">
              ...
              <form action="" id="infoCenter">
                  ...
                  <b><span class="req">*</span>身&nbsp;&nbsp;份&nbsp;&nbsp;证：</b><input type="text" id="IDNumber"  name="IDNumber" required="required"/><br><br>
                  ...
                  <!--可编辑-->
                  <b><span class="req">*</span>手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机：</b><input type="text" name="phoneNumber" id="phoneNumber" required="required"/><br><br>
                  ...
                  <b>国&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;籍：</b><input type="text" id="country"  name="country"/><br><br>

                  <!--可编辑-->
                  <b>毕业院校：</b><input type="text" id="education"  name="education"/><br><br>

                  <!--可编辑-->
                  <b>个人描述：</b><textarea name="description" id="description"></textarea><br><br>

                  <input type="checkbox" name="agreement" value="1" checked="checked" id="agreement"/>我已看过并接受<a href="">《用户协议》</a><br><br>
